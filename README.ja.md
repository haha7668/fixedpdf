...
## 📄 ライセンス
[GNU AGPL-3.0 ライセンス](LICENSE)

> 本プロジェクトは [PyMuPDF](https://github.com/pymupdf/PyMuPDF)（AGPL-3.0）を統合しているため、AGPL-3.0 で配布されます。第三者ライセンスについては [THIRD_PARTY_NOTICES.md](THIRD_PARTY_NOTICES.md) をご覧ください。
