...
> Este proyecto se distribuye bajo AGPL-3.0 porque integra [PyMuPDF](https://github.com/pymupdf/PyMuPDF) (AGPL-3.0). Consulte [THIRD_PARTY_NOTICES.md](THIRD_PARTY_NOTICES.md) para los avisos de terceros.
